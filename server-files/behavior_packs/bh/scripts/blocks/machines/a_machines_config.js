...
const diffCapMachines = ['twm:harvester', 'twm:block_placer', 'twm:block_breaker', 'twm:induction_anvil', 'twm:mechanic_upper', 'twm:mechanic_hopper', 'twm:mechanic_dropper', 'twm:mechanical_spawner', 'twm:item_exporter', 'twm:fluid_extractor']

// Speed Formula: 1x, 1.25x, 1.75x, 2.5x, 3.5x, 5x, 6.5x, 8x, 10x
function speedCalculate(speed) {
    return 1 + 0.125 * speed * (speed + 1)
}

// Energy Cap Formula: 1x, 1.25x, 1.75x, 2.5x, 3.5x, 5x, 6.5x, 8x, 10x
function energyCapCalculate(energy) {
    return 1 + 0.125 * energy * (energy + 1)
}

// Energy Efficiency Formula: 0.8x, 0.6x, 0.4x, 0.25x, 0.20x, 0.15x 0.10x, 0.05x
function energyEfficienyCalculate(energy) {
    if (energy < 4) {
        return 1 - 0.2 * energy
    } else {
        return 1 - (0.95 - 0.05 * (8 - energy))
    }
}

export { acceptedUpgrades, diffCapMachines, speedCalculate, energyCapCalculate, energyEfficienyCalculate }

//////////////////////////////////////////////////////

// Crusher Settings
const crusheableItems = {
    // ========== COBBLESTONE ==========
...
const crusherSettings = { energyCost: 800, rateSpeedBase: 20, energyCap: 64000 }

export { crusheableItems, crusherSettings }

//////////////////////////////////////////////////////

// Sieve & Autosieve Settings
const sievableBlocks = {
    ...
    'twm:crushed_netherrack': [
        ...
        { item: 'twm:gold_chunk', amount: 1, prob: 33 },
    ...
    'twm:compressed_crushed_netherrack': [
        ...
        { item: 'twm:gold_chunk', amount: 9, prob: 33 },
...
const autosieveSettings = { energyCost: 1600, rateSpeedBase: 40, energyCap: 64000 }

export { sievableBlocks, meshMulti, autosieveSettings }
//////////////////////////////////////////////////////
...
const incineratorSettings = { energyCost: 800, rateSpeedBase: 20, energyCap: 64000 }

export { smeltableItems, incineratorSettings }
//////////////////////////////////////////////////////

// Block Placer and Block Breaker Settings

const blockPlacerSettings = { energyCost: 100, energyCap: 64000 }

const blockBreakerSettings = { energyCost: 100, energyCap: 64000 }

export { blockPlacerSettings, blockBreakerSettings }
//////////////////////////////////////////////////////

// Input: { ouput, how much input does it needs}
...
const electroPressSettings = { energyCost: 800, rateSpeedBase: 20, energyCap: 64000 }

export { pressableItems, electroPressSettings }
//////////////////////////////////////////////////////


// Infuse Input: { Infused Input, Infuse Input Amount} 
const infusableItems = {
    'minecraft:redstone': {
...
const infuserSettings = { energyCost: 800, rateSpeedBase: 20, energyCap: 64000 }

export { infusableItems, infuserSettings }
//////////////////////////////////////////////////////

//Input
const meltableItems = {
    'minecraft:cobblestone': {
        liquid: 'lava', amount: 250
    },
    'minecraft:stone': {
        liquid: 'lava', amount: 250
    },
...
const magmaticChamberSettings = { energyCost: 8000, rateSpeedBase: 200, energyCap: 512000, lavaCap: 16000 }

export { meltableItems, magmaticChamberSettings }
//////////////////////////////////////////////////////
...
const seedSynthesizerSettings = { rateSpeedBase: 160, energyCap: 512000 }

export { growableItems, seedSynthesizerSettings, acceptedSoils }
//////////////////////////////////////////////////////


// Assembler
const assemblerSettings = { energyCost: 1600, rateSpeedBase: 20, energyCap: 256000 }


export { assemblerSettings }

// Digitizer
const digitizerSettings = { energyCost: 100, rateSpeedBase: 5, energyCap: 64000 }
...
export { digitizerSettings, recipes }
