...
import { msg, formattedEnergy, formattedEnergyv1, displayBar, transferItems, returnFunction, displayEnergy } from '../../generators/utils.js'
import { setQuality } from '../../generators/utility_quality.js'

import { crusheableItems, crusherSettings, speedCalculate, energyEfficienyCalculate } from './a_machines_config.js'

const { energyCost, energyCap, rateSpeedBase } = crusherSettings
    ...
    eventData.blockComponentRegistry.registerCustomComponent('twm:crusher', {
        beforeOnPlayerPlace(e) {
            ...
            system.run(() => {
                ...
                entity.nameTag = 'entity.twm:crusher.name'
        ...
        onTick(e) {
            ...
            const itemToProcess = crusheableItems[item?.typeId]
            ...
            if (itemToProcess.amount > amountLeft) {
                displayBar(energy, energyCap, rateSpeedBase * speedMulti, inv, 'energy', energyEfficiency);
                returnFunction(entity, block, inv, 4)
                return;
            }
            ...
            if (progress >= energyCost) {
                ...
                inv.addItem(new ItemStack(itemToProcess.output, processCount * itemToProcess.amount));
